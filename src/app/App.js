...
import { childRootIsShowingSetState,selectImgsRendered,selectSpinnerIsShowing } from '../features/imgStateSlice'
...
const BlogApp = () => {  
  ...
  return (
    <div id='childRoot' onAnimationEnd={() => {dispatch(childRootIsShowingSetState())}} style={{opacity: 0}} className={imgsRendered ? 'animate__animated animate__fadeIn fast' : null}>
      <Router />
      {
