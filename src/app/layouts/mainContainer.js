...
import { imgsRenderedSetState,spinnerIsShowingSetState,childRootIsShowingSetState,selectImgsRendered,selectChildRootIsShowing } from '../../features/imgStateSlice'
...
export const MainContainer = () => {
  ...
  return (
    <div>    
      <Container fluid>        
        <Row className='justify-content-center header' style={{minHeight: '100px'}}>          
          <HeaderComponent />
          <div className='position-absolute header headerOverlay p-0 d-flex align-items-center' style={{minHeight: '100px'}}>
        ...
        <Row className='justify-content-between mx-1 p-0'>
          <Col><h3 className={'mb-0 ' + fontSizes.h3}>{wordSplit(location)}</h3></Col>
          <Col className='d-flex align-items-end justify-content-end'>
            ...
            <Link to='allPosts'>
              <h6 className={'link-primary ' + fontSizes.h6}>View all posts -></h6>
            </Link>        
          </Col>
          <hr />
        </Row>
        <Container fluid className='justify-content-center row m-0 p-0' id='postContainer'>      
...
export const SpinnerLoader = () => {
  ...
  const spinnerClass = 'd-flex align-items-center justify-content-center vw-100 vh-100 position-absolute top-0 start-0 bg-light';
  ...
  return (
    <div className={ toggleSpinnerClass() } id='spinnerLoader' 
      onAnimationEnd={()=>{
        dispatch(spinnerIsShowingSetState());        
      }}
    >
